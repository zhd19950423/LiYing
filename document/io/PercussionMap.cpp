...
//     if (!ok)
//         QMessageBox::critical(0, tr("梨音教学工具"), tr("couldn't open file '%1'").arg(handler.errorString()));
...
//     if (!ok)
//         QMessageBox::critical(0, tr("梨音教学工具"), tr("couldn't parse chord dictionary : %1").arg(handler.errorString()));
    return ok;
}
